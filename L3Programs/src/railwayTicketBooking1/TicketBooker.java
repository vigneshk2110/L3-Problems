...
public class TicketBooker
{
    ...
    static int availableLowerBerths = 7;//normally 21
    static int availableMiddleBerths = 7;//normally 21
    static int availableUpperBerths = 7;//normally 21
    static int availableRacTickets = 3;//normally 18
    ...
    static List<Integer> lowerBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7));//normally 1,2,...21
    static List<Integer> middleBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7));//normally 1,2,...21
    static List<Integer> upperBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5,6,7));//normally 1,2,...21
    static List<Integer> racPositions = new ArrayList<>(Arrays.asList(1,2,3));//normally 1,2,...18
