...
public class Main
{
	...
	public static void bookTicket(Passenger p)
	{
		...
		if((p.berthPreference.equals("L") && TicketBooker.availableLowerBerths > 0 )||(p.berthPreference.equals("l") && TicketBooker.availableLowerBerths > 0 )||
				(p.berthPreference.equals("M") && TicketBooker.availableMiddleBerths > 0) || (p.berthPreference.equals("m") && TicketBooker.availableMiddleBerths > 0)||
				(p.berthPreference.equals("U") && TicketBooker.availableUpperBerths > 0) ||  (p.berthPreference.equals("u") && TicketBooker.availableUpperBerths > 0))
		{
